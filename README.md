...
- MIDI file loading and demo playback
- 88-key piano-roll visualization
- Adjustable visual effects and color palettes
- Cinema mode and WebM recording
- Web Audio piano synthesis
- Browser preview through Vite
